...
export const arithmeticFunctions: Record<string, CljValue> = {
  ...
  '-': v.nativeFn('-', function subtract(...nums: CljValue[]) {
    if (nums.length === 0) {
  ...
  '*': v.nativeFn('*', function multiply(...nums: CljValue[]) {
    if (nums.length === 0) {
      return cljNumber(1)
    }
    const badIdx = nums.findIndex(function isNotNumber(a) {
  ...
  '/': v.nativeFn('/', function divide(...nums: CljValue[]) {
    if (nums.length === 0) {
      throw new EvaluationError('/ expects at least one argument', {
        args: nums,
      })
  ...
  '>': v.nativeFn('>', function greaterThan(...nums: CljValue[]) {
    if (nums.length < 2) {
  ...
  '<': v.nativeFn('<', function lessThan(...nums: CljValue[]) {
    if (nums.length < 2) {
      throw new EvaluationError('< expects at least two arguments', {
        args: nums,
      })
  ...
  '>=': v.nativeFn('>=', function greaterThanOrEqual(...nums: CljValue[]) {
    if (nums.length < 2) {
      throw new EvaluationError('>= expects at least two arguments', {
        args: nums,
      })
  ...
  '<=': v.nativeFn('<=', function lessThanOrEqual(...nums: CljValue[]) {
    if (nums.length < 2) {
      throw new EvaluationError('<= expects at least two arguments', {
        args: nums,
      })
  ...
  '=': v.nativeFn('=', function equals(...vals: CljValue[]) {
    if (vals.length < 2) {
      throw new EvaluationError('= expects at least two arguments', {
        args: vals,
      })
  ...
  inc: v.nativeFn('inc', function increment(x: CljValue) {
  ...
  dec: v.nativeFn('dec', function decrement(x: CljValue) {
    if (x === undefined || x.kind !== 'number') {
  ...
  max: v.nativeFn('max', function maximum(...nums: CljValue[]) {
    if (nums.length === 0) {
  ...
  min: v.nativeFn('min', function minimum(...nums: CljValue[]) {
    if (nums.length === 0) {
  ...
  mod: v.nativeFn('mod', function modulo(n: CljValue, d: CljValue) {
  ...
  'even?': v.nativeFn('even?', function isEven(n: CljValue) {
    if (n === undefined || n.kind !== 'number') {
  ...
  'odd?': v.nativeFn('odd?', function isOdd(n: CljValue) {
    if (n === undefined || n.kind !== 'number') {
  ...
  'pos?': v.nativeFn('pos?', function isPositive(n: CljValue) {
    if (n === undefined || n.kind !== 'number') {
  ...
  'neg?': v.nativeFn('neg?', function isNegative(n: CljValue) {
    if (n === undefined || n.kind !== 'number') {
  ...
  'zero?': v.nativeFn('zero?', function isZero(n: CljValue) {
    if (n === undefined || n.kind !== 'number') {
  ...
  abs: v.nativeFn('abs', function absImpl(n: CljValue) {
    if (n === undefined || n.kind !== 'number') {
  ...
  quot: v.nativeFn('quot', function quotImpl(num: CljValue, div: CljValue) {
  ...
  rem: v.nativeFn('rem', function remImpl(num: CljValue, div: CljValue) {
    if (num === undefined || num.kind !== 'number') {
  ...
  rand: v.nativeFn('rand', function randImpl(...args: CljValue[]) {
  ...
  'rand-int': v.nativeFn('rand-int', function randIntImpl(n: CljValue) {
    if (n === undefined || n.kind !== 'number') {
  ...
  'rand-nth': v.nativeFn('rand-nth', function randNthImpl(coll: CljValue) {
  ...
  shuffle: v.nativeFn('shuffle', function shuffleImpl(coll: CljValue) {
  ...
  'bit-and': v.nativeFn('bit-and', function bitAndImpl(x: CljValue, y: CljValue) {
  ...
  'bit-or': v.nativeFn('bit-or', function bitOrImpl(x: CljValue, y: CljValue) {
  ...
  'bit-xor': v.nativeFn('bit-xor', function bitXorImpl(x: CljValue, y: CljValue) {
  ...
  'bit-not': v.nativeFn('bit-not', function bitNotImpl(x: CljValue) {
  ...
  'bit-shift-left': v.nativeFn('bit-shift-left', function bitShiftLeftImpl(x: CljValue, n: CljValue) {
  ...
  'bit-shift-right': v.nativeFn('bit-shift-right', function bitShiftRightImpl(x: CljValue, n: CljValue) {
  ...
  'unsigned-bit-shift-right': v.nativeFn('unsigned-bit-shift-right', function unsignedBitShiftRightImpl(x: CljValue, n: CljValue) {
