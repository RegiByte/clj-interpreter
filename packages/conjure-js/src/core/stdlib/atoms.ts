import { isAtom, isAFunction, isDelay, isEqual, isReduced, isVolatile, isFalsy } from '../assertions'
...
export const atomFunctions: Record<string, CljValue> = {
  atom: v.nativeFn('atom', function atom(value: CljValue) {
  ...
  deref: v.nativeFn('deref', function deref(value: CljValue) {
  ...
  'atom?': v.nativeFn('atom?', function isAtomPredicate(value: CljValue) {
  ...
  'reset-vals!': v.nativeFn('reset-vals!', function resetVals(atomVal: CljValue, newVal: CljValue) {
    if (!isAtom(atomVal)) {
  ...
  'compare-and-set!': v.nativeFn('compare-and-set!', function compareAndSet(atomVal: CljValue, oldv: CljValue, newv: CljValue) {
    if (!isAtom(atomVal)) {
  ...
  'remove-watch': v.nativeFn('remove-watch', function removeWatch(atomVal: CljValue, key: CljValue) {
    if (!isAtom(atomVal)) {
