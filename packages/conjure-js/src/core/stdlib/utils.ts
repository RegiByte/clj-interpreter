...
export const utilFunctions: Record<string, CljValue> = {
  str: v.nativeFn('str', function strImpl(...args: CljValue[]) {
    return cljString(
  ...
  type: v.nativeFn('type', function typeImpl(x: CljValue) {
    if (x === undefined) {
  ...
  gensym: v.nativeFn('gensym', function gensymImpl(...args: CljValue[]) {
    if (args.length > 1) {
  ...
  // (namespace :foo)      => nil
  // (namespace 'user/foo) => "user"
  namespace: v.nativeFn('namespace', function namespaceImpl(x: CljValue) {
    if (x === undefined) {
  ...
  // (name :foo)      => "foo"
  // (name 'user/foo) => "foo"
  name: v.nativeFn('name', function nameImpl(x: CljValue) {
    if (x === undefined) {
  ...
  keyword: v.nativeFn('keyword', function keywordImpl(...args: CljValue[]) {
  ...
  boolean: v.nativeFn('boolean', function booleanImpl(x: CljValue) {
  ...
  'pr-str': v.nativeFn('pr-str', function prStrImpl(...args: CljValue[]) {
  ...
  'pretty-print-str': v.nativeFn('pretty-print-str', function prettyPrintStrImpl(...args: CljValue[]) {
  ...
  'read-string': v.nativeFn('read-string', function readStringImpl(s: CljValue) {
    if (s === undefined || s.kind !== 'string') {
  ...
  'prn-str': v.nativeFn('prn-str', function prnStrImpl(...args: CljValue[]) {
    return cljString(args.map(printString).join(' ') + '\n')
  }).doc(
  ...
  'print-str': v.nativeFn('print-str', function printStrImpl(...args: CljValue[]) {
  ...
  'println-str': v.nativeFn('println-str', function printlnStrImpl(...args: CljValue[]) {
    return cljString(args.map(valueToString).join(' ') + '\n')
  }).doc(
    'println to a string.',
    [['&', 'args']]
  ...
  symbol: v.nativeFn('symbol', function symbolImpl(...args: CljValue[]) {
    if (args.length === 0 || args.length > 2) {
